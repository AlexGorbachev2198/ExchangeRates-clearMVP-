...
public class CustomerRepaymentFromAccountCompleteRequest extends StampedRequest {
    private String transRef;
    private OperationConfirmationProvidedDataEntry dataResponse;

    public CustomerRepaymentFromAccountCompleteRequest() {
    }

    public CustomerRepaymentFromAccountCompleteRequest(String transRef, OperationConfirmationProvidedDataEntry dataResponse) {
